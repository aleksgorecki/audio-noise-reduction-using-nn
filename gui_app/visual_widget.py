...
class VisualWidget(QWidget):
    ...
    def plot_noisy(self, data):
        ...
        visual.plot_waveform(data, fs=16000, show=False, fig=self.time_noisy_fig, ax=time_ax, eng=True)
        visual.plot_spectrogram(data, fs=16000, show=False, fig=self.spec_noisy_fig, ax=spec_ax, eng=True)
    ...
    def plot_predicted(self, data):
        ...
        visual.plot_waveform(data, fs=16000, show=False, fig=self.time_pred_fig, ax=time_ax, eng=True)
        visual.plot_spectrogram(data, fs=16000, show=False, fig=self.spec_pred_fig, ax=spec_ax, eng=True)
    ...
    def plot_clean(self, data):
        ...
        visual.plot_waveform(data, fs=16000, show=False, fig=self.time_clean_fig, ax=time_ax, eng=True)
        visual.plot_spectrogram(data, fs=16000, show=False, fig=self.spec_clean_fig, ax=spec_ax, eng=True)
