...
class DenoisingWavenetWithoutConditioning():
    ...
    def build_model(self):
        ...
        for stack_i in range(self.num_stacks):
            ...
            for dilation in self.dilations:
                res_block_i += 1
                data_out, skip_out = self.dilated_residual_block_without_conditioning(data_out, res_block_i, layer_in_stack, dilation, stack_i)
